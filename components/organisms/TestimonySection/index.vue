<template>
  <div id="testimony" class="container pt-20">
    ...
    <div
      class="scroll-testimony tn:p-4 tn:flex tn:space-x-6 tn:overflow-x-scroll tn:overscroll-auto lg:block lg:grid lg:overflow-visible lg:overscroll-none lg:grid-cols-2 lg:justify-center lg:space-x-0 lg:gap-6 lg:place-items-stretch lg:items-stretch"
    >
      <TestimonyCard
