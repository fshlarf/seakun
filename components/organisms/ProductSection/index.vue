<template>
  <div id="provider" class="container iner tn:pt-8 lg:pt-20">
    <div class="">
      ...
      <div class="tn:mt-4">
        <div
          ...
          class="w-full h-full grid xl:grid-cols-4 grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 lg:gap-6 px-0 justify-center"
        >
      ...
      <div class="tn:mt-4">
        <div
          v-if="!isLoadingProduct"
          class="w-full h-full grid xl:grid-cols-4 grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 lg:gap-6 px-0 justify-center place-items-stretch items-stretch items-center"
        >
