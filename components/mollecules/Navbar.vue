<template>
  <div
    id="navbar"
    class="w-full bg-white fixed z-40 tn:py-2 md:py-2 tn:shadow px-2"
  >
    ...
    >
      ...
      <div
        class="absolute tn:top-1 tn:right-1 tn:py-3 tn:px-3 md:px-3 lg:top-1.5 lg:right-0 lg:relative z-100 flex flex-col tn:w-3/5 md:w-1/2 lg:w-4/5 rounded-xl lg:p-0 lg:justify-end lg:flex-row lg:items-center"
